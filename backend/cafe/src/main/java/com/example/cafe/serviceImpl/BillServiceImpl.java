...
public class BillServiceImpl implements BillService {
    ...
    public ResponseEntity<String> generateReport(Map<String, Object> requestMap) {
        ...
        try {
            ...
            if(validateRequestMap(requestMap)){
                ...
                PdfWriter.getInstance(document, new FileOutputStream(CafeConsents.STORE_LOCATION+"\\"+fileName+".pdf"));
            ...
            return CafeUtils.getResponseentity("Required data is not exist", HttpStatus.BAD_REQUEST);
        }catch (Exception ex){
            ex.printStackTrace();
        }
    ...
    private boolean validateRequestMap(Map<String, Object> requestMap) {
        log.info("Inside validate request");
    ...
    public ResponseEntity<byte[]> getPdf(Map<String, Object> requestMap) {
        ...
        try{
            ...
            String filePath=CafeConsents.STORE_LOCATION+"\\"+(String) requestMap.get("uuid")+".pdf";
